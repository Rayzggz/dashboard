...
price = {
    ...
    "Chilled Water": {"unit": 1 / 1.03073, "2018": 0.2556, "2019": 0.3018, "2020": 0.3169, "2021": 0.3312,
                      "2022": 0.4041},
...
def getMonthlyCost(target_data: list):
    """
    Get Monthly Cost
    :param target_data:
    :return:
    ...
    for label in target_data[0]:
        ...
        # noinspection PyTypeChecker
        tmp = washData(target_data[1][index],
                       [len(target_data[1][0]) - TimeUnit.day.value * 30, len(target_data[1][0])],
