document.getElementById('graph_2_d1').innerHTML = '<h2>{{ graph_2_d1_data }} kBTU</h2>';

document.getElementById('graph_2_d2').innerHTML = '<h2>{{ graph_2_d2_data }} $</h2>';

document.getElementById('graph_2_d3').innerHTML = '<h2>{{ graph_2_d3_data }} $</h2>';
