document.getElementById('graph_2_d1').innerHTML = '<h1 class="mdui-center">{{ graph_2_d1_data }} kBTU</h1>';

document.getElementById('graph_2_d2').innerHTML = '<h1 class="mdui-center">{{ graph_2_d2_data }} $</h1>';

document.getElementById('graph_2_d3').innerHTML = '<h1 class="mdui-center">{{ graph_2_d3_data }} $</h1>';
